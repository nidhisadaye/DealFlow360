...
const riskyResult = evaluateDeal(
  riskyDeal,
  customer,
  products,
  rules,
...
const healthyInventory: Inventory[] = [
  {
    id: "INV-003",
    warehouseId: "WH-MUM",
    productId: "PROD-HW-001",
...
const healthyResult = evaluateDeal(
  healthyDeal,
  customer,
  products,
  rules,
...
const negativeMarginInventory: Inventory[] = [
  {
    id: "INV-004",
    warehouseId: "WH-MUM",
    productId: "PROD-HW-001",
...
const negativeMarginResult = evaluateDeal(
  negativeMarginDeal,
  customer,
  products,
  rules,
  negativeMarginInventory,
  warehouses
);
...
const zeroInventoryResult = evaluateDeal(
  zeroInventoryDeal,
  customer,
  products,
  rules,
...
const noActiveWarehousesDeal: Deal = {
  id: "DEAL-005",
  customerId: "CUST-001",
  salesRepId: "USER-001",
...
const noActiveWarehousesInventory: Inventory[] = [
  {
    id: "INV-006",
    warehouseId: "WH-MUM",
    productId: "PROD-HW-001",
...
const noActiveWarehouses: Warehouse[] = [
  {
    id: "WH-MUM",
    name: "Mumbai Warehouse",
    location: "Mumbai",
...
const noActiveWarehousesResult = evaluateDeal(
  noActiveWarehousesDeal,
  customer,
  products,
  rules,
  noActiveWarehousesInventory,
  noActiveWarehouses
);
...
const missingTierRules: DiscountRule[] = [
  {
    id: "RULE-HARDWARE",
    name: "Hardware Discount Limit",
    productCategory: "Hardware",
...
const missingTierInventory: Inventory[] = [
  {
    id: "INV-007",
    warehouseId: "WH-MUM",
    productId: "PROD-HW-001",
...
const missingTierResult = evaluateDeal(
  missingTierDeal,
  customer,
  products,
  missingTierRules,
  missingTierInventory,
  warehouses
);
...
const reevaluationInventory: Inventory[] = [
  {
    id: "INV-008",
    warehouseId: "WH-MUM",
    productId: "PROD-HW-001",
...
const initialEvaluation = evaluateDeal(
  initialDeal,
  customer,
  products,
  rules,
  reevaluationInventory,
  warehouses
);
...
const reevaluatedEvaluation = evaluateDeal(
  updatedDeal,
  customer,
  products,
  rules,
...
console.log("\nCHECKS:");
console.log(
  `Discount changed from ${initialDeal.discountPercent}% to ${updatedDeal.discountPercent}%`
);
